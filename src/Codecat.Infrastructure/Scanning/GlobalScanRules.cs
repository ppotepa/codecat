...
public static class GlobalScanRules
{
    ...
    {
        ".a", ".aab", ".aar", ".ai", ".apk", ".avif", ".bmp", ".class", ".db", ".dex",
        ".dll", ".dmg", ".doc", ".docx", ".eot", ".exe", ".gif", ".ico", ".jar", ".jpeg",
        ".jpg", ".map", ".mp3", ".mp4", ".msi", ".o", ".otf", ".pdf", ".png", ".pdb",
        ".ppt", ".pptx", ".so", ".sqlite", ".svg", ".tar", ".ttf", ".webm", ".webp",
